<template>
  ...
  >
    <div
      class="border-2 rounded border-gray-400 w-6 h-6 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-green-700 transition-colors duration-200"
      :class="checkbox ? 'bg-green-500' : 'bg-white'"
    >
      <input
        type="checkbox"
      ...
      <div
        ...
        :class="checkbox ? 'text-white' : 'text-green-500'"
      >
        {{ character }}
      </div>
    </div>
